export default {
  ...
  fund: {
    ...
    otc_qj: '区间内的值',
    otc_from: '从',
    totlo: '請勿向上述地址充值任何非本幣種資產，否則資產將不可找回',
    total_assets: '总资产',
    fun_flow: '资金流水',
    hide_assets: '隐藏零资产',
    currency: '币种',
  ...
  userinfo: {
    ...
    personal: {
      ...
      upload_3: '本人身份证背面照片',
      upload_4: '手持证件与个人签名',
      upload_5: '请您上传一张手持身份证正面照和个人签字的照片，个人签名的内容包含真实姓名和当前日期。请确保照片和个人签字的内容清晰可见<br /> 照片要求：  头像清晰  身份证号码清晰  包含个人签名  包含当天日期',
      upload_6: '护照封面',
      upload_7: '护照个人信息页',
      upload_8: '请您上传一张手持护照正面照和个人签字的照片，个人签名的内容包含真实姓名和当前日期。请确保照片和个人签字的内容清晰可见<br /> 照片要求：  头像清晰  护照号码清晰  包含个人签名  包含当天日期',
      hidden: '隐藏',
      change: '筛选',
      pleaseInput: '请上传',
      QRcode: '长按图片，保存二维码',
      copyUrl: '复制链接',
      upload_txt: '請您上傳一張手持證件正面照和個人簽字的照片，個人簽名的內容包含真實姓名和當前日期。請確保照片和個人簽字的內容清晰可見'
    }
  },
  phoneCode: {
