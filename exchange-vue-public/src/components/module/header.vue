            ...
            <ul class="header-ul clearfix">
              ...
              <template v-if="siteType.indexOf('ex') !== -1">
                ...
                <li v-if="public_info.contractOpen === '1'">
                  <a :href="http + webSiteInfo.co_pc_url + '/index'">{{ Internationalization.co }}</a>
                </li>
                   <!-- 场外交易首页 -->
                <li v-if="public_info.otcOpen === '1'">
                  <a :href="http + webSiteInfo.otc_pc_url + '/index'">{{ Internationalization.transaction }}</a>
                </li>
                <li>|</li>
                <li>
              ...
              <template v-if="siteType.indexOf('co') !== -1">
                <li v-if="public_info.exOpen === '1'">
                  <!-- 币币交易首页 -->
                  <a :href="http + webSiteInfo.ex_pc_url + '/index'" >{{ Internationalization.currency }}<span></span></a>
                </li>
                <li>
                  <!-- 合约交易首页 -->
                ...
                <li v-if="public_info.otcOpen === '1'">
                   <!-- 场外交易首页 -->
                  <a :href="http + webSiteInfo.otc_pc_url + '/index'" >{{ Internationalization.transaction }}<span></span></a>
                </li>
                <li>|</li>
                <li>
              ...
              <template v-if="siteType.indexOf('otc') !== -1">
                ...
                <li v-if="public_info.contractOpen === '1'">
                  <!-- 合约交易首页 -->
                  <a :href="http + webSiteInfo.co_pc_url + '/index'" >{{ Internationalization.co }}<span></span></a>
                </li>
                <li>
                   <!-- 场外交易首页 -->
          ...
          <div class="header-right">
            <ul class="rightNav">
              <template v-if="islogin">
                <!-- <template v-if="siteType.indexOf('otc') !== -1">
                  <li class="rightNav_item"> 
                    <router-link to="/publishAds" class="creatButton publishAds">{{ Internationalization.publish }}</router-link>
                  </li>
                  <li class="rightNav_item"> 
                    <router-link to="/otc_personal" class="otc_personal"><i class=" icon-user"></i> {{ Internationalization.my }}</router-link>
                  </li>
                  <li class="rightNav_item otc_btn">|</li>
                </template> -->
                <li class="rightNav_item">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="javascript:;" @click="logout">
                          <i class="icon-logout"></i>{{$t('public.hd.logout')}}
                        </a>
                      </li>
                    </ul>
                  </a>
              ...
              <li class="rightNav_item" :class="{right_active:appdown}" @mouseover="over" @mouseout="out" v-if="downurl.app_page_url">
                    <a href="javascript:;">
                      {{$t('main.app_download')}}
                      <div class="qr_code_wrap" v-if="appdown">
                          <div class="qr_code">
                ...
                <!-- <li class="rightNav_item">
                    <router-link to="/download/main"><span>{{$t('main.app_download')}}</span></router-link>
                </li> -->
              <li class="rightNav_item">
