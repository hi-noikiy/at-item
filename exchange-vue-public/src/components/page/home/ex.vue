          ...
          <div v-if="JSON.stringify(symbolTop) == '{}'">
           ...
           <div class="recomm-content borderbox" v-for="(item, index) in symbolTop" :key="index" v-else>
             <div class="content">
                ...
                <p class="price" :class="item.rose.class">{{item.close.data}}</p>
            ...
            <table>
                 <thead>
                  ...
                  <tbody v-if="symbolListArr.length > 0">
                    <tr v-for="(item, index) in symbolListArr" v-if="item.isShow" :key="index" :class="{symboy_bgc: index % 2 === 0 }" @click="transaction(item.symbol)">
                        <td class="mark"> 
                          ...
                          <i class="icon-cor icon-store"  @click.stop="changeMysymbol(item.symbol)"  v-else></i>
                         <span>{{item.symbol}}</span></td>
