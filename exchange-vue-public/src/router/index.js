...
myRouter.beforeEach((to, from, next) => {
  ...
  // 未登录可以访问的页面
  let arr = ['index', 'cms', 'register', 'trade', 'help_center', 'forgetPassword', 'login', 'notice_info', 'otcIndex', 'otc_home', 'otc_ads_Hall', 'otc_personal', 'contract', 'mining', 'download', 'upgrade']
  // 已登录不可以访问的页面
